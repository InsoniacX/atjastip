...
export default function Navbar() {
    ...
    return (
        ...
        <header className="fixed background inset-x-0 backdrop-blur-sm bg-white/30 top-0 z-50">
        <nav aria-label="Global" className="flex  justify-between p-2 lg:px-8 shadow-lg">
          <div className="flex">
          ...
          <div className="flex lg:hidden">
            ...
            >
              <span className="sr-only">Open amain menu</span>
